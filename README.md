...
- ACME HTTP-01 challenge responder: place tokens in `BALOR_ACME_CHALLENGE_DIR` (default `data/acme-challenges`) and they will be served from `/.well-known/acme-challenge/*`; full cert automation is in progress.
